...
public class URIHandler {
    ...
    public static String doGet(String uri,String failure) {
        ...
        try {
            Log.d("AndroidDaycare","GET uri: " + uri);
            URL url = new URL(uri);
            ...
            Log.d("AndroidDaycare","Received: " + result);
            return result;

        } catch(Exception ex) {
            Log.d("AndroidDaycare","Exception in doGet: "+ex.getMessage());
        } finally {
            if (is != null) {
                try {
                    is.close();
    ...
    public static String doPost(String uri, String data) {
        ...
        try {
            Log.d("AndroidDaycare","Post uri: " + uri);
            URL url = new URL(uri);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("POST");
            Log.d("AndroidDaycare","Posted: " + data);
            conn.setDoInput(true);
            ...
            Log.d("AndroidDaycare","Exception in doPost: "+ex.getMessage());
        } finally {
            if (is != null) {
                try {
                    is.close();
    ...
    public static String doPut(String uri, String data) {
        ...
        try {
            Log.d("AndroidDaycare","Put uri: " + uri);
            URL url = new URL(uri);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("PUT");
            Log.d("AndroidDaycare","Put: " + data);
            conn.setDoInput(true);
            conn.setDoOutput(true);
            conn.setRequestProperty("Content-Type", "application/json");
            OutputStream os = conn.getOutputStream();
            ...
            Log.d("AndroidDaycare","Exception in doPut: "+ex.getMessage());
        } finally {
            if (is != null) {
                try {
                    is.close();
    ...
    public static void doDelete(String uri) {
        try {
            Log.d("AndroidDaycare","DELETE uri: " + uri);
            URL url = new URL(uri);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
